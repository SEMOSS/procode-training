...
public class GetGttPhysicianCaseReactor extends AbstractTQMCReactor {

  public GetGttPhysicianCaseReactor() {
  ...
  protected NounMetadata doExecute(Connection con) throws SQLException {
    ...
    Map<String, Object> c = TQMCHelper.getGttPhysicianCaseMap(con, userId, caseId);
